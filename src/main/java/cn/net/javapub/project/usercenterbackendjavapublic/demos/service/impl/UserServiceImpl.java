package cn.net.javapub.project.usercenterbackendjavapublic.demos.service.impl;
...
import cn.net.javapub.project.usercenterbackendjavapublic.demos.mapper.UserMapper;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
     ...
     */
    @Override
    public long userRegister(String userAccount, String userPassword, String checkPassword, String planetCode, Integer userRole) {
        // 1. 校验
...
// [加入我们](http://javapub.net.cn) 从 0 到 1 项目实战，经验拉满！10+ 原创项目手把手教程、7 日项目提升训练营、1000+ 项目经验笔记、60+ 编程经验分享直播